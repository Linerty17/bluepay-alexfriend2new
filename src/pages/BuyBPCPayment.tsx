      ...
      <div className="bg-white m-4 p-3 rounded-lg border border-gray-200">
        <div className="mb-3">
          ...
          <div className="flex justify-between items-center">
            <p className="text-lg font-bold">NGN 10000</p>
            <Button
              variant="default"
              size="sm"
        ...
        <div className="mb-3 border-t pt-3">
          ...
          <div className="flex justify-between items-center">
            <p className="text-lg font-bold">5634957767</p>
            <Button
              variant="default"
              size="sm"
              className="bg-blue-600 hover:bg-blue-700 flex items-center gap-1"
              onClick={() => handleCopy("5634957767", "Account Number")}
            >
              <Copy size={14} />
              Copy
            </Button>
        ...
        <div className="mb-3 border-t pt-3">
          ...
          <p className="text-lg font-bold">BLESSING ARUWAYO</p>
        </div>
      </div>
